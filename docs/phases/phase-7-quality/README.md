...
Cross-cutting quality features: internationalization, accessibility, and user documentation.
...
- All features in this phase can be worked on in parallel
- i18n and WCAG should be applied retroactively to all existing UI
