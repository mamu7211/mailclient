...
public class ResourceCompletenessTests
{
    ...
    [
        ...
        "ComposeSubject",
        "ComposeBody",
        "ComposePlaceholderTo",
        "ComposePlaceholderCc",
        "ComposePlaceholderBcc",
        "ComposePlaceholderSubject",
        "ComposeShowCcBcc",
        "ComposeModeRichText",
        "ComposeModeMarkdown",
        "ComposeButtonSend",
        "ComposeButtonSending",
        "ComposeSendSuccess",
        "ComposeSendFailed",
        "ComposeValidationTo",
        "ComposeValidationSubject",
        "ComposeValidationBody",
        "ComposeValidationEmail",
